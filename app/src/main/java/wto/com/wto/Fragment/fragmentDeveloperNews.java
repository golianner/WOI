...
public class fragmentDeveloperNews extends Fragment {
    ...
    public fragmentDeveloperNews(List<OnlineNewsModel> listNews) {
        this.listNews = listNews;
    }

    public fragmentDeveloperNews() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstance) {
        View view = inflater.inflate(R.layout.fragment_developer_news, container, false);
        //Get Session
